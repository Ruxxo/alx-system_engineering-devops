...
14-change_owner_and_group - Write a script that changes the owner to betty and the group owner to  for all the files and directories in the working directory.
...
101 - Create a man that looks exactly like this one and passes all checks.
